...
document.addEventListener("DOMContentLoaded", function () {
                ...
                row.innerHTML = `
                                                        <td class="pro-thumbnail">
                                                            <div class="pro-info text-center">
                                                                <div class="pro-img">
                                                                    <a href="#"><img src="https://www.crystalsbyriya.com/images/${item.image}" alt="${item.productName}" /></a>
                                                                </div>
    ...
    document.getElementById("list-orders-list").addEventListener("click", loadOrders);
});
const detailPageBaseUrl = '@Url.Content("~/detail")'; // Base URL for the detail page with `/detail` included

function getWishlist() {
    $.ajax({
        url: '@Url.Page("/dashboard", "Wishlist")',
        type: 'GET',
        success: function (response) {
            let wishlistTableBody = '';
            const imageBasePath = '@Url.Content("https://www.crystalsbyriya.com/images/")'; // Set base path for images
...
function removeFromWishlist(productId) {
    $.ajax({
        url: '@Url.Page("/dashboard", "RemoveFromWishlist")', // Adjust URL to match your Razor Page route
        type: 'POST',
