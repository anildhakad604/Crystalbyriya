        ...
        if (query.length > 2) {
            $.ajax({
                ...
                `);
                        ...
                        $('#search-results-inline2').append('<p>No results found</p>');  // Corrected the quotes here
                    }
                },
            ...
            $('#search-results-inline2').hide().empty();
        }
    });
});
