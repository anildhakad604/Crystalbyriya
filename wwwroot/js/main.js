...
(function ($) {
  ...
  var clickModalSecond = function () {
    ...
    $(".btn-add-note, .btn-estimate-shipping, .btn-add-gift").on(
      "click",
      function () {
        var classList = {
  ...
  var textCopy = function () {
    $(".coupon-copy-wrap,.btn-coppy-text").on("click", function () {
      const couponCode = $(this)
        .closest(".discount-bot,.wrap-code")
        .find(".coupon-code,.coppyText")
        .text()
        .trim();
  ...
  var clickActive = function () {
    ...
    $(".btn-active").on("click", function (event) {
      ...
      const isResponsive =
        $container.hasClass("active-1600") && window.innerWidth < 1600;
      ...
      if (isResponsive) {
        ...
        $(".main-action-active").each(function () {
          ...
          if (
            this !== $container[0] &&
            (!$other.hasClass("active-1600") || window.innerWidth < 1600)
          ) {
  ...
  var RTL = function () {
    var isRTL =
      $("body").hasClass("rtl") || localStorage.getItem("dir") === "rtl";
