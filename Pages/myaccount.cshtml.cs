...
namespace CrystalByRiya.Pages
{
    public class myaccountModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPost(string Email, string phone, string redirectUrl)
        {
        ...
        public async Task<IActionResult> OnPostLoginAsync(string redirectUrl)
        {
            ...
            if (isexist != null)
            {
                ...
                HttpContext.Session.SetString("UserEmail", isexist.Email);
                HttpContext.Session.SetString("UserName", isexist.Name); // Assuming Name field exists
                HttpContext.Session.SetString("Password", isexist.Password);
